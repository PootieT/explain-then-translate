...
class PythonProcessor(LangProcessor):
    ...
    def get_function_name(self, function):
        ...
        func_name = function[function.index("def") + 1]
    ...
    def extract_arguments(self, function):
        ...
        arg_str = " ".join(function[function.index("def") + 3: function.index(")")])
        args = arg_str.split(",")
        arg_types, arg_names = [], []
        for arg in args:
            if ":" in arg:
                arg_types.append(arg.split(":")[1])
            else:
                arg_types.append("")
            arg_names.append(arg.split(":")[0])
