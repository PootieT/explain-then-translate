...
Disclaimer: This page is left mostly unchanged from MultiPL-E tutorial. If you want to 
introduce new programming language, consider contributing to MultiPL-E, then
we can extend it to MultiPL-C2C.
...
1. An evaluator for your new language that goes in [evaluation/src](https://github.com/PootieT/explain-then-translate/MultiPL-C2C/tree/main/evaluation/src); and

2. A translator for your new language that goes in [dataset_builder](https://github.com/PootieT/explain-then-translate/MultiPL-C2C/tree/main/dataset_builder).
